...
###########################################################################################
"""ResNet block, 3 streams and each streams has 3 blocks"""
###########################################################################################
"""###################################################################################"""   
...
class CIFARNet(NN.Module):
    def __init__(self, numChannels, classes):
        ...
        self.Conv1_S1_3 = NN.Conv2d(in_channels = Conv1OutputChannel, 
                                out_channels = Conv1OutputChannel, 
                                kernel_size = Conv2Filter_Size, 
                                stride = Conv1Stride,
                                padding = 1)
        ...
        self.Conv2_S1_3 = NN.Conv2d(in_channels = Conv1OutputChannel, 
        ...
        self.Conv1_S2_3 = NN.Conv2d(in_channels = Conv2OutputChannel, 
                                out_channels = Conv2OutputChannel, 
                                kernel_size = Conv2Filter_Size, 
                                stride = Conv1Stride,
                                padding = 1)
        ...
        self.Conv2_S2_3 = NN.Conv2d(in_channels = Conv2OutputChannel, 
                                out_channels = Conv2OutputChannel, 
                                kernel_size = Conv2Filter_Size, 
                                stride = Conv2Stride,
                                padding = 1)
        ...
        self.Conv1_S3_3 = NN.Conv2d(in_channels = Conv3OutputChannel, 
                                out_channels = Conv3OutputChannel, 
                                kernel_size = Conv2Filter_Size, 
                                stride = Conv1Stride,
                                padding = 1)
        ...
        self.Conv2_S3_3 = NN.Conv2d(in_channels = Conv3OutputChannel, 
                                out_channels = Conv3OutputChannel, 
                                kernel_size = Conv2Filter_Size, 
                                stride = Conv2Stride,
                                padding = 1)
    ...
    def forward(self, input):
        ...
        identity5 = self.ConvDownSample_BatchNorm_Main_3(self.ConvDownSample_Main_3(identity5))
        input += identity5
